...
export class AddOrEditEmployeeComponent implements OnInit, AfterViewInit{
  ...
  jobTitle: Title[] = [
    ...
    {value: 'Junior_Software_Development', viewValue: 'Junior Software Development'},
  ...
  updateTitleFilters(){
    ...
    // this.dataService.titleFilterRecord['Job_Title'][this.employeeData.jobTitle].count += 1;
    // this.dataService.titleFilterRecord['Job_Title'][this.employeeData.jobTitle].id.push(this.dataService.totalCount);
    // //console.log(this.employeeData.department, this.dataService.titleFilterRecord['Department'][this.employeeData.department])
    // this.dataService.titleFilterRecord['Department'][this.employeeData.department].count += 1;
    // this.dataService.titleFilterRecord['Location'][this.employeeData.location].count += 1;
  }
  ...
  removeID(parent:string,child:string){
    let index = this.dataService.titleFilterRecord[parent][child].id.indexOf(this.dataService.profileSlected);
  ...
  clearFilters(){
    ...
    this.dataService.selectedFiltersList.Job_Title.count = 0;
    this.dataService.selectedFiltersList.Job_Title.list = [];
    this.dataService.selectedFiltersList.Department.count = 0;
    this.dataService.selectedFiltersList.Department.list = [];
    this.dataService.selectedFiltersList.Location.count = 0;
    this.dataService.selectedFiltersList.Location.list = [];
    this.dataService.selectedFiltersList.alphabeticalFilters.count = 0;
    this.dataService.selectedFiltersList.alphabeticalFilters.list = [];
